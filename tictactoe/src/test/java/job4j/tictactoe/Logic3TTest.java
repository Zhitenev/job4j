...
//    }
    ...
    public void whenHasOWinner() {
        Figure3T[][] table = {
                {new Figure3T(true, true), new Figure3T(), new Figure3T()},
                {new Figure3T(true, false), new Figure3T(true, true), new Figure3T()},
                {new Figure3T(true, false), new Figure3T(), new Figure3T(true, true)},
        };
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerO(), is(true));
    }
